/*CMD
  command: /startadminmultidepoextezt
  help: 
  need_reply: true
  auto_retry_time: 
  folder: 
...
Bot.setProperty("multi_deposit_channel_text",message,"string")
Api.deleteMessage({chat_id:chat.chatid,message_id:request.message_id})

var txt="*Your text for multi deposit channel has been updated successfully*"
