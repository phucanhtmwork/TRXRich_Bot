/*CMD
  command: /resetdefaultmultidepositrext01
  help: 
  need_reply: 
  auto_retry_time: 
  folder: 
...
if(chat.chatid==ad){
Bot.setProperty("multi_deposit_channel_text",false,'boolean')
let txt="<b>Multi Deposit Channel Text Reseted to Deafult</b>"
