...
}else if(dep_type=="dep4"){
Bot.run( {
    command: "/adc"+" "+am+" "+list+" "+sx+" "+cur+" "+"dep4",
    run_after: 60*daily_hour4,  
    chat_id: chat.id,  
    user_id: user.id  
} )
}else if(dep_type=="dep5"){
Bot.run( {
    command: "/adc"+" "+am+" "+list+" "+sx+" "+cur+" "+"dep5",
...
if((dep_type=="dep1")||(dep_type=="dep2")||(dep_type=="dep3")||(dep_type=="dep4")||(dep_type=="dep5")){
