...
let pl4=Bot.getProperty("daily_amount4")
let pl5=Bot.getProperty("daily_amount5")
let lv2=Bot.getProperty("daily_value1")
let lv3=Bot.getProperty("daily_value2")
let lv4=Bot.getProperty("daily_value3")
let lv5=Bot.getProperty("daily_value4")
...
Bot.sendMessage("⛔️ *COINPAYMENTS KEYS* not set.  Set it on adminpanel /adminlogin")
return
}
if(!cur_info){
...
if((!hr3)||(!hr2)||(!hr4)||(!hr5)||(!hr1)){
Bot.sendMessage("⛔️* Investment Accural Hour* not set. First set it from adminpanel. Type /adminlogin")
return
}
if((!daily_amount)||(!daily_expired)||(!pl2)||(!pl3)||(!pl4)||(!pl5)){
Bot.sendMessage("⛔️*Investment Percent* not set. Set it on adminpanel.  /adminlogin")
return
}
...
let bal = Libs.ResourcesLib.userRes("balance");
Bot.sendMessage("To use this bot You must join our payment chnanel @Chnnael link"  )
}}else{
let bal = Libs.ResourcesLib.userRes("balance");
Bot.sendMessage("To use this bot You must join our payment chnanel @Chnnael link"  )
}
