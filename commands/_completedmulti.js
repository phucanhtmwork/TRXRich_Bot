...
let daily_amount4=Bot.getProperty("daily_amount4")
let daily_amount5=Bot.getProperty("daily_amount5")
...
let daily_hour4=Bot.getProperty("daily_hour4")
let daily_hour5=Bot.getProperty("daily_hour5")
...
let daily_value3=Bot.getProperty("daily_value3")
let daily_value4=Bot.getProperty("daily_value4")
...
let mokkka4=daily_amount4*1
let hmokkka4=mokkka4/100
let mokka40=hmokkka4*1
let peh4=amount*mokka40
let mokkka5=daily_amount5*1
let hmokkka5=mokkka5/100
let mokka50=hmokkka5*1
let peh5=amount*mokka50
...
let gvsr2="✅ *New Investment Started in Bot*\n\n📆* Total Investment Duration: *"+daily_expired*daily_hour1+" Minutes, for a daily "+daily_amount1+"%\n\n🗒 _Get paid on Every Day_\n\n⏱* Payment "+daily_amount1+"% Every "+daily_hour1+" Minutes*\n\n*💴 Invested Amount: *"+amount+" "+cur+"\n\n🧮 *Expected Return: *"+mgt+" "+cur
...
let gvsr2="✅ *New Investment Started in Bot*\n\n📆* Total Investment Duration: *"+daily_expired*daily_hour2+" Minutes, for a daily "+daily_amount2+"%\n\n🗒 _Get paid on Every Day_\n\n⏱* Payment "+daily_amount2+"% Every "+daily_hour2+" Minutes*\n\n*💴 Invested Amount: *"+amount+" "+cur+"\n\n🧮 *Expected Return: *"+mgt+" "+cur
Bot.sendMessage(gvsr2)
} else if((amount>=daily_value2)&&(amount<daily_value3)){
Bot.run( {
    command:'/adc'+' '+peh3+' '+relg75.value()+' '+amount+' '+optionss.currency+' '+'dep3',
    run_after:60*daily_hour3,  
    chat_id: chat.id,  
    user_id: user.id  
} )
...
let gvsr2="✅ *New Investment Started in Bot*\n\n📆* Total Investment Duration: *"+daily_expired*daily_hour3+" Minutes, for a daily "+daily_amount3+"%\n\n🗒 _Get paid on Every Day_\n\n⏱* Payment "+daily_amount3+"% Every "+daily_hour3+" Minutes*\n\n*💴 Invested Amount: *"+amount+" "+cur+"\n\n🧮 *Expected Return: *"+mgt+" "+cur
Bot.sendMessage(gvsr2)
} else if((amount>=daily_value3)&&(amount<daily_value4)){
Bot.run( {
    command:'/adc'+' '+peh4+' '+relg75.value()+' '+amount+' '+optionss.currency+' '+'dep4',
    run_after: 60*daily_hour4,  
    chat_id: chat.id,  
    user_id: user.id  
} )
let kotta1=amount*mokka40
let kondal=daily_expired*1
let mgt=kotta1*kondal
var planhr=daily_hour4
let gvsr2="✅ *New Investment Started in Bot*\n\n📆* Total Investment Duration: *"+daily_expired*daily_hour4+" Minutes, for a daily "+daily_amount4+"%\n\n🗒 _Get paid on Every Day_\n\n⏱* Payment "+daily_amount4+"% Every "+daily_hour4+" Minutes*\n\n*💴 Invested Amount: *"+amount+" "+cur+"\n\n🧮 *Expected Return: *"+mgt+" "+cur
Bot.sendMessage(gvsr2)
} else if(amount>=daily_value4){
Bot.run( {
    command:'/adc'+' '+peh5+' '+relg75.value()+' '+amount+' '+optionss.currency+' '+'dep5',
    run_after:60*daily_hour5,  
    chat_id: chat.id,  
    user_id: user.id  
} )
let kotta1=amount*mokka50
let kondal=daily_expired*1
let mgt=kotta1*kondal
var planhr=daily_hour5
let gvsr2="✅ *New Investment Started in Bot*\n\n📆* Total Investment Duration: *"+daily_expired*daily_hour5+" Minutes, for a daily "+daily_amount5+"%\n\n🗒 _Get paid on Every Day_\n\n⏱* Payment "+daily_amount5+"% Every "+daily_hour5+" Minutes*\n\n*💴 Invested Amount: *"+amount+" "+cur+"\n\n🧮 *Expected Return: *"+mgt+" "+cur
Bot.sendMessage(gvsr2)
}
